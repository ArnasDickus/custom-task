    ...
    <ContainerPageLang>
      <LargeWrapper>
        ...
        <DataPiece
          ...
          text="I could write unit tests, add translations, add route translations, implement static side rendering for this page. Implement a way to measure performance etc."
        />
      </LargeWrapper>
    </ContainerPageLang>
  );
